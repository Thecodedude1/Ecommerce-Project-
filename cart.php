...
<div class="container">
    <div class="card shopping-cart">
        <div class="card-header bg-dark text-light">
            ...
            Shopping cart
            <a href="store.php" class="btn btn-outline-info btn-sm pull-right">Continiue shopping</a>
        ...
        <div class="card-footer">
            ...
            <h4><label for="specialNotes">Reward points: <?php echo ceil($points) ?></label></h4>
