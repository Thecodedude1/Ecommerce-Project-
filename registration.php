                ...
                <div class="row my-4">
                  <div class="col-12">
                    <div class="custom-control custom-control-alternative custom-checkbox">
                      ...
                      <label class="custome-control-label" for="customCheckRegister"><input type="checkbox" required="required"> I accept the <a href="#">Terms of Use</a> &amp; <a href="#">Privacy Policy</a></label>                    </div>
                  </div>
                </div>
                <div class="text-center">
                <button name="registration" type="submit" class="btn btn-info">Create account</button>
                </div>
              </form>
            </div>
          </div>
